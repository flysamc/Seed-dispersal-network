;breeds of birds species increase by slider no. of species also no. of indiviudal in each species (fixed or random)
to setup
...
Aim: A modeling approach to quantify the consequences of downsizing—relative to random extinctions—for the number of interactions and secondary plant extinctions(as measures of structural robustness) and for long-distance seed dispersal (as a measure of ecosystem function)
Model: Here we create interaction network (Links) between bird and Plant species baesd on observation of real world interaction network (ref). 
...
------------------
Entities: 
Diffrent # of bird species (Breeds), Different # of plant species(Patches), Links between bird and plants species (Links)
-------------------
Variables:
